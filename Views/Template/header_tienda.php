...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?= media() ?>/tienda/css/list.css">
	<!--===============================================================================================-->
</head>
...
<body class="animsition">
	...
	<header>
					...
					<ul class="menu-horizontal">
						...
						<li>
							...
							<ul class="menu-vertical">
								...
								<li><a href="#">Pop/Romántica</a></li>
								<li><a href="#">Reggae</a></li>
								<li>
									<hr class="dropdown-divider">
								</li>
								<li><a href="<?= base_url(); ?>/Pasados">Ver todo</a></li>
							</ul>
						</li>
						<!-- Próximos -->
						<li>
							...
							<ul class="menu-vertical">
								...
								<li><a href="#">Flamenco/Tango</a></li>
								<li><a href="#">Urbanos</a></li>
								<li><a href="#">Internacional</a></li>
								<li>
									<hr class="dropdown-divider">
								</li>
								<li><a href="<?= base_url(); ?>/Proximos">Ver Todo</a></li>
							</ul>
						</li>
						<!-- En Oferta -->
						<li>
							<a href="#">En oferta</a>
							<ul class="menu-vertical">
								<li><a href="#">Folclor/Popular</a></li>
								<li><a href="#">Jazz/Instrumental</a></li>
								<li><a href="#">Oldies/Trova</a></li>
								<li><a href="#">Comedia</a></li>
								<li><a href="#">Musicales</a></li>
								<li>
									<hr class="dropdown-divider">
								</li>
								<li><a href="<?= base_url(); ?>/Oferta">Ver Todo</a></li>
							</ul>
						</li>
					</ul>
		...
		<!-- Header Mobile -->
		<div class="wrap-header-mobile" style="color: white;">
			<!-- Logo moblie -->
		...
		<!-- Menu Mobile -->
		<div class="menu-mobile" style="color: white;">
